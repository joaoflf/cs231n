...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2_row_size = int(num_filters * input_dim[1]/2 * input_dim[2]/2)
    ...
    def loss(self, X, y=None):
        ...
        out_1_shape = out_1.shape
    
        
        out_2, fc_cache_1 = affine_relu_forward(out_1, W2, b2)
        scores, fc_cache_2 = affine_forward(out_2, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx3, grads['W3'], grads['b3'] = affine_backward(dx4, (out_2, W3, b3))
        dx2, grads['W2'], grads['b2'] = affine_relu_backward(dx3, fc_cache_1)
        dx, grads['W1'], grads['b1']=  conv_relu_pool_backward(dx2, cache_1)
        ...
        if self.reg:
            ...
            grads['W3'] += 0.5 * 2 * self.reg * self.params['W3']'''
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
