...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        a1, fc_cache1 = affine_relu_forward(X, self.params['W1'], self.params['b1'])
        
        a2, fc_cache2 = affine_forward(a1, self.params['W2'], self.params['b2'])
        scores= a2
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx2, grads['W2'], grads['b2'] = affine_backward(dx3, (a1, self.params['W2'], self.params['b2']))
        dx, grads['W1'], grads['b1'] = affine_relu_backward(dx2, fc_cache1)
    ...
    def loss(self, X, y=None):
        ...
        if self.reg:
            ...
            for i in range(1, self.num_layers+1):
                loss_reg += np.sum(np.square(self.params['W'+str(i)]))
